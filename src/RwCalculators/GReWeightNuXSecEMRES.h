...
\class    genie::rew::GReWeightNuXSecEMRES
...
#ifndef _G_REWEIGHT_NU_XSEC_EMRES_H_
#define _G_REWEIGHT_NU_XSEC_EMRES_H_
...
namespace rew   {
 ...
 class GReWeightNuXSecEMRES : public GReWeightModel
 {
 public:
   static const int kModeMaMv             = 0;
   static const int kModeNormAndMaMvShape = 1;

   GReWeightNuXSecEMRES();
   GReWeightNuXSecEMRES(std::string model, std::string type);
  ~GReWeightNuXSecEMRES();
